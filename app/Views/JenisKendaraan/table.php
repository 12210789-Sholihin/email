...
<table id='table-jeniskendaraan' class="datatable table table-bordered border-primary">
    <thead>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Jenis Kendaraan</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="varchar" name="jenis" class="form-control"/>
                        </div>
                    <div class="mb-3">
...
<script>
    $(document).ready(function(){
        ...
        $('table#table-jeniskendaraan').on('click', '.btn-edit', function(){
            let id =$(this).data('id');
        ...
        $('table#table-jeniskendaraan').on('click', '.btn-hapus', function(){
            let konfirmasi = confirm('jenis kendaraan akan dihapus, ingin melanjutkan?');
